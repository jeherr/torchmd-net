...
class Denali(Dataset):
    ...
    atomic_numbers = {b'H': 1, b'B': 5, b'C': 6, b'N': 7, b'O': 8, b'F': 9,
                        b'Si': 14, b'P': 15, b'S': 16, b'Cl': 17, b'Br': 35,
                        b'I': 53
    }
    least_squares = {
        'H': -6.03263218e-01 * HARTREE_TO_EV,
        'B': -2.49721136e+01 * HARTREE_TO_EV,
        'C': -3.81057896e+01 * HARTREE_TO_EV,
        'N': -5.47526175e+01 * HARTREE_TO_EV,
        'O': -7.52314113e+01 * HARTREE_TO_EV,
        'F': -9.98653320e+01 * HARTREE_TO_EV,
        'Si': -2.89537825e+02 * HARTREE_TO_EV,
        'P': -3.41469688e+02 * HARTREE_TO_EV,
        'S': -3.98195126e+02 * HARTREE_TO_EV,
        'Cl': -4.60212840e+02 * HARTREE_TO_EV,
        'Br': -2.57421501e+03 * HARTREE_TO_EV,
        'I': -2.97774639e+02 * HARTREE_TO_EV
    }
    ...
    def get_atomref(self, max_z=100):
        ...
        out[list(self.atomic_numbers.values())] = torch.tensor(list(self.least_squares.values()))
